...
class NotesBackend(BaseBackend):
    """User backend for note records."""
    ...
    def get_user_permissions(
        ...
        # Allow all authenticated users to create notes. The update mutation handles
